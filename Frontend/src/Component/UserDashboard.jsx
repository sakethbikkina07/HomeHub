...
function Dashboard() {
  ...
  return (      
      <div className="max-w-full mx-auto bg-white overflow-hidden shadow-xl p-6">
        ...
        <div className="w-full flex justify-between items-start mb-10 gap-4">
          <div className="bg-[#98A886] p-6 rounded-2xl w-full md:w-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {properties.map((item) => (
            <div key={item} className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-100">
              <img src={building} alt="house" className="w-full h-40 object-cover" />
