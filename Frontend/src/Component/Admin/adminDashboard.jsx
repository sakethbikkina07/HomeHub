    ...
    <div className="min-h-screen bg-[#f9f9f9] p-6">
      ...
      <nav className="w-9/12 m-auto flex items-center justify-between bg-white rounded-full px-6 py-3 border border-gray-200 shadow-md">
        ...
        <div className="flex items-center gap-4">
          <button className="w-10 h-10 rounded-full border-1 border-gray-300 flex items-center justify-center bg-white shadow-sm cursor-pointer hover:border-2 hover:border-[#CBA358] hover:shadow-md transition">
