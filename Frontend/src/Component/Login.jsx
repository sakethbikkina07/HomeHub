    ...
    <div className="relative w-full min-h-screen overflow-y-auto lg:overflow-hidden bg-zinc-900">
      ...
      <div className="relative lg:absolute inset-0 flex items-center justify-center min-h-screen p-4 sm:p-6 z-10">
        <form
          ...
          className="w-full max-w-md lg:max-w-none lg:w-[32%] rounded-[25px] sm:rounded-[35px] bg-black/20 sm:bg-white/5 backdrop-blur-[100px] border border-white/30 sm:border-white/50 shadow-2xl px-6 py-8 sm:px-10 sm:py-6"
        >
          {/* Home Icon Header */}
          ...
          <div className="relative mb-4 sm:mb-6">
            ...
            <input
              ...
              className="w-full h-12 sm:h-14 rounded-xl sm:rounded-2xl bg-white pl-12 sm:pl-14 pr-4 sm:pr-5 text-gray-700 text-sm sm:text-base placeholder:text-gray-400 outline-none"
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-12 sm:h-14 rounded-xl sm:rounded-2xl bg-white pl-12 sm:pl-14 pr-12 sm:pr-14 text-gray-700 text-sm sm:text-base placeholder:text-gray-400 outline-none"
            />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-12 sm:h-14 rounded-xl sm:rounded-2xl bg-[#D4A017] hover:bg-yellow-600 disabled:opacity-50 shadow-lg mt-6 sm:mt-8 text-white text-lg sm:text-xl font-semibold transition duration-300 cursor-pointer"
          >
